...
<template>
    <div ref="rootRef" class="min-h-screen min-w-fit isolate bg-[#2b2b36] p-12">
        <div class="flex flex-col gap-12">
            <div
                v-for="(page, index) in props.pages"
                :key="index"
                data-preview-frame
                class="relative w-max mx-auto overflow-x-auto rounded border-2 border-dashed border-white/30 p-0"
            >
                <div data-preview-inner class="inline-block align-top">
