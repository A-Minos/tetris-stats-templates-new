...
import { z } from 'zod';
import sprint from '~/assets/images/card/sprint.svg';
...
<template>
    <template v-if="valid">
        <div class="w-68.75 h-31.25 rounded-7.5 relative shadow-[0rem_0.5625rem_1.5625rem_0rem_rgba(0,0,0,0.15)]">
            <img :src="sprint" class="absolute top-0 left-0" />

            <div class="absolute top-4.75 left-6">
                <span class="font-template text-6.25 fw-800 color-[#b42323]">
                    {{ $t('common.game_mode.sprint') }}
                </span>
            </div>
